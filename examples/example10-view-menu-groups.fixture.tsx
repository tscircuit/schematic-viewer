    ...
    <div style={{ position: "relative", height: "100%" }}>
      ...
      >
        ...
        <div style={{ marginTop: "8px", fontSize: "12px", color: "#666" }}>
          This example demonstrates the view menu functionality. The circuit contains:
          ...
          Click the view menu icon (crosshair) in the top-right to see view options.
          <br/><br/>
          <small>Note: Groups may not be explicitly defined in this circuit, but the view menu infrastructure is ready.</small>
        </div>
      </div>
      <SchematicViewer
