...
export const SchematicViewer = ({
  ...
  return (
    <MouseTracker>
      <style>
        {`[data-circuit-json-type="schematic_trace"].same-net-trace-hover { filter: invert(1); }
[data-circuit-json-type="schematic_trace"].same-net-trace-hover .trace-crossing-outline { opacity: 0; }`}
      </style>
      {onSchematicComponentClicked && (
        <style>
